# -*- coding: utf-8 -*-
# Django settings for wirecloudtest project.
...
DATABASES = {
    'default': {
        ...
        'NAME': path.join(BASEDIR, 'wirecloudtest.db'),           # Or path to database file if using sqlite3.
...
SECRET_KEY = '&f3^s2z@$yh)2$=1mc-+!++lz6mamk*cx-3fl5p%262u)rzdae'

ROOT_URLCONF = 'wirecloudtest.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'wirecloudtest.wsgi.application'
