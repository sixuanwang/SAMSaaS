# -*- coding: utf-8 -*-
# Django settings for instance1 project.
...
DATABASES = {
    'default': {
        ...
        'NAME': path.join(BASEDIR, 'instance1.db'),           # Or path to database file if using sqlite3.
...
SECRET_KEY = 'ortblj-crk0pycm#lo##dom@g+92s5u3a%)&6()3$f01@n6i^i'

ROOT_URLCONF = 'instance1.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'instance1.wsgi.application'
